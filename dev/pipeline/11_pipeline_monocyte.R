library(episcope)
# rm(build_link_status_matrix); source("R/utils_step2_connect_tf_genes.R")
...
load_config("dev/config/GSE87218_monocyte_jaspar2024.yaml")
...
if (do_load_footprints_preprocess == TRUE) {
  ...
  omics_data <- load_prep_multiomic_data(
    config = "dev/config/GSE87218_monocyte_jaspar2024.yaml",
    genome = ref_genome,
