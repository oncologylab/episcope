...
step2_gene_log2fc_cutoff <- if (regulated_genes == 1.5) 0.585 else if (regulated_genes == 2) 1 else NA_real_
...
step2_bulk <- episcope::filter_links_deltas_bulk(
  ...
  abs_delta_min = -Inf,
  apply_de_gene = TRUE,
  gene_log2fc_cutoff = step2_gene_log2fc_cutoff,
  fp_cutoff = fp_delta_cutoff,
  tf_opposition_log2fc_cutoff = step2_gene_log2fc_cutoff,
