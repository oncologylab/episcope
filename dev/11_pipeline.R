...
fp_manifest <- load_footprints(
  root_dir   = "/data/homes/yl814/tbio/package_test/GSE87218_ATAC/TOBIAS_merged_peaks",
  db_name    = "JASPAR2024",
  out_dir    = "/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_jaspar2024",
  n_workers  = 20,
  # n_samples  = 2,
...
readr::write_csv(fp_manifest, "/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_jaspar2024_manifest.csv")
fp_manifest <- readr::read_csv("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_jaspar2024_manifest.csv")
...
readr::write_csv(fp_aligned$fp_bound, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_bounds_", db, ".csv"))
readr::write_csv(fp_aligned$fp_score, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_scores_", db, ".csv"))
readr::write_csv(fp_aligned$fp_annotation, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_annotation_", db, ".csv"))
...
readr::write_csv(fp_aligned_normalized$fp_score, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_scores_qn_", db, ".csv"))
...
sample_metadata <- readr::read_tsv("/data/homes/yl814/episcope_test/GSE87218_ATAC/GSE87218_samples_filtered.txt", na = "NA")
...
atac_data    <- readr::read_tsv("/data/homes/yl814/episcope_test/GSE87218_ATAC/All_ATAC.master_table.narrowpeaks.10mil.txt")
...
rna <- readr::read_tsv("/data/homes/yl814/episcope_test/GSE87218_ATAC/GSE85243_counts.median_ratio_normalized_group_averages_mapped_to_SRR.ALL.tsv")
...
fp_aligned_normalized_manifest <- save_footprints(fp_aligned_normalized, out_dir  = paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_aligned_normalized_", db))
readr::write_csv(fp_aligned_normalized_manifest, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_aligned_normalized_manifest_", db, ".csv"))
...
fp_aligned_normalized_filtered_manifest <- filter_footprints(
  ...
  out_dir             = paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_aligned_normalized_filtered_", db),
...
readr::write_csv(fp_aligned_normalized_filtered_manifest, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_jaspar2024/fp_aligned_normalized_filtered_manifest_", db, ".csv"))
...
fp_corr_manifest <- tf_corr_footprints(
  ...
  out_dir     = paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_aligned_normalized_filtered_corr_", db),
  build_args  = rna_atac_build_args,
  n_workers   = 15,
  cor_method  = "pearson",
  min_non_na  = 5L
)
readr::write_csv(fp_corr_manifest, paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_aligned_normalized_filtered_corr_manifest_", db, ".csv"))
...
combined      <- tf_corr_footprints_filter(fp_corr_manifest, p_thr = threshold_fp_tf_corr_p, r_thr = threshold_fp_tf_corr_r, output_bed = paste0("/data/homes/yl814/episcope_test/GSE87218_ATAC/fp_predicted_tfbs_", db))
