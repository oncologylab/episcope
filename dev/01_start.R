...
golem::fill_desc(
  ...
  pkg_description = "Robust and reproducible framework for epigenetic data analysis. It integrates functionalities for ChromHMM analysis, DNA methylation assessment, differentiation state profiling, nutrient stress analysis, and functional mapping to facilitate comprehensive epigenomic studies.",
  authors = c(
    person(
      given = "Yaoxiang",
      family = "Li",
