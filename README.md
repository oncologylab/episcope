CraftGRN: Combined RNA and ATAC Footprint Training of Gene Regulatory Network
===========================================================================================

[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg?style=plastic)](https://github.com/oncologylab/craftgrn)
...
**CraftGRN** is a modular framework for integrating **chromatin accessibility (ATAC)** and **transcriptomic (RNA-seq)** data to infer condition-specific **TF binding sites (TFBS)**, and reconstruct dynamic **gene regulatory networks (GRNs)**.
...
CraftGRN is an R package available on GitHub.
...
### [**Module 2: Connect TFs to Target Genes**](https://github.com/oncologylab/craftgrn/wiki/Module-2:-Connect-TFs-to-Target-Genes)
...
### [**Module 3: Learn Regulatory Topics & Visualize Differential GRNs**](https://github.com/oncologylab/craftgrn/wiki/Module-3:-Learn-Regulatory-Topics-&-Visualize-Differential-GRNs)
...
CraftGRN supports multiple orchestrated pipelines:

- **Snakemake** - scalable, HPC-optimized  
- **Nextflow** - reproducible, cloud-ready  
- **R scripts** - local exploratory runs

👉 https://github.com/oncologylab/craftgrn_snakemake  
👉 https://github.com/oncologylab/craftgrn_nextflow

---

## Help and Documentation

- 📘 Docs https://github.com/oncologylab/craftgrn/wiki  
- ❓ FAQ https://github.com/oncologylab/craftgrn/wiki/FAQ  
- 🐛 Bug report https://github.com/oncologylab/craftgrn/issues
...
**CraftGRN:** Integrative ATAC-RNA framework for condition-specific gene regulatory network analysis.

---

## License

This project is licensed under the [GNU General Public License v3.0](https://github.com/oncologylab/craftgrn/blob/main/LICENSE.md).
