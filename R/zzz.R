...
utils::globalVariables(c(
  ...
  "abs_log2fc", "assignment_method", "bin", "biological_separation_rank", "canonical", "canonical_display",
  "canonical_status", "canonical_symbol", "canonical_tf", "comparison_weight",
  ...
  "gene_ambiguous", "gene_canonical", "gene_expr", "gene_key__", "gene_key_upper",
  ...
  "pathway_norm_key", "pathway_species", "pathway_term", "payload_chunk", "phi",
  ...
  "target_mass", "term_group", "term_mass", "term_score", "term_size",
