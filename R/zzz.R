...
utils::globalVariables(c(
  ...
  "comparison_label", "condition_group", "condition_label", "context_type", "ctrl_id", "d2_loglik",
  "delta_abs", "delta_fp", "delta_fp_bed_score", "delta_fp_score",
  "delta_gene", "delta_gene_expr", "direction_label", "display_label", "doc_id",
  ...
  "marker_row_order", "max_doc_score", "max_score", "method", "method_order",
  "method_setup", "metric_group", "min_topic",
  "model_label", "modality", "n_down_total", "N_gene", "N_peak", "n_tokens",
  ...
  "selected_k", "setup", "setup_label", "tf_key", "tf_sum_abs_delta", "tf_sum_delta", "tf_term",
