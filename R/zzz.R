...
utils::globalVariables(c(
  ...
  "expression_2", "forced_min_terms", "fp_max", "fp_score", "fp_sum",
  ...
  "gene_key__", "gene_key_upper", "gene_maxprob_margin", "gene_maxprob_probability",
  "gene_maxprob_topic",
  ...
  "n_char", "n_docs", "n_documents", "n_pass", "n_regulating_tfs",
