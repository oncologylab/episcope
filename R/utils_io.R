...
#
# Purpose:
# Provide small shared helpers for reading and writing package data objects.
#
# Inputs:
# - in-memory omics data lists
# - file paths and output directories
#
# Outputs:
# - serialized RDS files
# - loaded in-memory objects
#
# Notes:
# - Keep this file generic and reusable across modules.
# - Module-specific output layouts belong in module files.
