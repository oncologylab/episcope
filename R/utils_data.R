...
#
# Purpose:
# Provide small shared data-shaping helpers used across modules.
#
# Inputs:
# - in-memory BED-like tables or BED file paths
# - window settings around a focal genomic position
#
# Outputs:
# - temporary BED files formatted for downstream tools
#
# Notes:
# - Keep this file generic and reusable across modules.
# - Module-specific genomic logic belongs in module files.
