...
.m3cr_network_panel_html <- function() {
  ...
  paste0(
    ...
    "<label title=\"Keep each TF only in its single model-wide topic with the highest mean raw theta across all available condition::TF documents.\">Primary topic only <input id=\"networkPrimaryOnly\" type=\"checkbox\" checked/></label>",
