...
function drawMds(){
  ...
  mdsLayoutLabels(labels,W,H,crowded?54:pad,crowded).forEach(q=>{
    ...
    const t=el('text',{x:q.x+5,y:q.y+(q.compact?19:25),'text-anchor':'start','font-size':q.fontSize||18,'font-weight':700,fill:q.c,style:'cursor:pointer;paint-order:stroke;stroke:#fff;stroke-width:5px;stroke-linejoin:round'});
