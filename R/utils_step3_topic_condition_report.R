...
.m3cr_network_panel_html <- function() {
  ...
  paste0(
    ...
    "<label id=\"networkPrimaryOnlyLabel\" title=\"Keep each TF only in its single model-wide primary topic, defined by the highest mean raw theta across all available condition::TF documents.\">Primary topic only <input id=\"networkPrimaryOnly\" type=\"checkbox\" checked/></label>",
