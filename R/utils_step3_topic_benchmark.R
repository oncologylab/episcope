...
.m3tb_condition_report_html <- function(title, group_mds, group_topic, pathways, out_html, mds_svg_src = NULL) {
  ...
  mds_img <- if (!is.null(mds_svg_src) && nzchar(mds_svg_src)) {
    sprintf(
      "<img id=\"mdsImage\" class=\"mdsImage\" src=\"%s\" alt=\"Condition and comparison MDS\"/><div id=\"mdsHotspotLayer\" class=\"mdsHotspotLayer\"></div><div class=\"tooltip\" id=\"mdsTooltip\"></div>",
