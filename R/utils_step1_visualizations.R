...
.module1_tfbs_explorer_components <- function(cache, default_condition, standalone = FALSE) {
  ...
  css <- paste(
    ...
    ".m1-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.m1-plot-card{border:1px solid var(--line);border-radius:4px;padding:8px 10px;overflow:hidden}.m1-plot-card h3{margin:0 0 4px;font-size:13px}.m1-chart{width:100%;min-height:190px;max-height:360px;overflow-y:auto;overflow-x:hidden;scrollbar-gutter:stable}.m1-chart svg{display:block;width:100%;height:auto}.m1-bar{fill:#315f97;cursor:pointer}.m1-bar.co{fill:#16847a}.m1-bar.rest{fill:#dbe5ef}.m1-bar.reference{fill:#fbe8e8;stroke:#b2182b;stroke-width:2}.m1-bar.highlight,.m1-dot.highlight{stroke:#b2182b;stroke-width:3}.m1-axis-label{font-size:11px;fill:#334155}.m1-value{font-size:11px;font-weight:700;fill:#172033}.m1-canonical{font-size:11px;font-weight:800;fill:#b2182b}.m1-reference-line{stroke:#9ca3af;stroke-width:1;stroke-dasharray:4 4}.m1-stem{stroke:#315f97;stroke-width:2}.m1-dot{fill:#6486af;cursor:pointer}.m1-status{font-size:11px;color:#526071;margin:5px 0}.m1-status.error{color:#a33b20}.m1-selected{display:flex;flex-wrap:wrap;gap:5px;min-height:24px;align-items:center}.m1-chip{display:inline-flex;align-items:center;gap:4px;border:1px solid #9fb4cc;background:#eef4fa;border-radius:999px;padding:3px 7px;font-size:11px;font-weight:700}.m1-chip button{border:0;background:transparent;padding:0;color:#7f1d1d;font-weight:800}",
